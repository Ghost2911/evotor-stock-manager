...
namespace EvotorStockManager
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            if (EvotorAPI.TOKEN == String.Empty)
                MessageBox.Show("Для продолжения работы укажите TOKEN в классе EvotorAPI");
            if (EvotorAPI.STORE_ID == String.Empty)
                MessageBox.Show("Не указан идентификатор магазина (STORE_ID) в классе EvotorAPI");
        }
